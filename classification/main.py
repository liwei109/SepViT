...
def get_args_parser():
    parser = argparse.ArgumentParser('SepViT training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=64, type=int)
    parser.add_argument('--epochs', default=300, type=int)

    # Model parameters
    parser.add_argument('--model', default='SepViT_Tiny', type=str, metavar='MODEL',
    ...
    parser.add_argument('--weight-decay', type=float, default=0.05,
                        help='weight decay (default: 0.05)') # 0.1 
    ...
    parser.add_argument('--warmup-epochs', type=int, default=5, metavar='N',
                        help='epochs to warmup LR, if scheduler supports') # 20
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('SepViT training and evaluation script', parents=[get_args_parser()])
